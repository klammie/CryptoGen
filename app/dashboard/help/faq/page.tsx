...
const Home: React.FC = () => {
  ...
  >([
    ...
    },
    {
      ...
      content:
        "Yes, Cryptocurrency trading carries inherent risks due to the volatility of the market. Prices can fluctuate significantly, leading to potential losses. The great thing about our Ai is it has been tested for years and has a consistent winrate of over 70% ",
    },
    {
      id: 3,
      title: "How to add funds to account",
      content:
