          ...
          <div className="flex flex-col items-center mx-auto gap-8">
            <div className="w-full text-center">
              ...
              <p className="text-lg text-center leading-7 text-white">
                ...
                commissions whether you win or lose.
                <br />
                <br />
                Now, imagine an application created by traders, for traders. An
                application designed to eliminate those long hours spent sitting
                in front of a computer analyzing the market, implementing
                strategies, and waiting for setups to play out. No more entering
                trades too early out of fear of missing out, or too late due to
                a lack of confidence in your strategy.
                <br />
                <br />
                That’s where <strong>CryptoGen</strong> comes in.{" "}
                <strong>CryptoGen</strong> removes the hard work and mental
